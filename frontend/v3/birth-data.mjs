import { birthSearchScope, normalizeBirthDate, normalizeBirthTime } from "../src/birth-input.mjs";
export { normalizeBirthDate, normalizeBirthTime, buildBirthRequest as buildReadingRequest } from "../src/birth-input.mjs";
