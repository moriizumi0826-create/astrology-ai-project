...
import { monthlyOverviewForDate } from "../src/monthly-overview.mjs";
import {
  CalendarDays,
  ChevronDown,
  ChevronLeft,
...
const postDashboardJson = (url, payload) => postJson(url.replace("/api/readings", "/api/paid-reading"), payload);
