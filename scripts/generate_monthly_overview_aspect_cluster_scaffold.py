...
CLUSTER_DEFINITIONS: dict[str, list[dict[str, object]]] = {
    ...
    "2026-10": [
        {
            "Cluster_ID": "2026_10_OPENING_TSQUARE_COMPLETION",
            "Event_Type": "aspect_cluster",
            "Valid_From": "2026-10-01T00:00:00+09:00",
            "Peak_At": "2026-10-02T18:14:00+09:00",
            "Valid_To": "2026-10-04T23:59:59+09:00",
            "Carryover_Flag": 1,
            "Participating_Planets": "MERCURY|MARS|PLUTO",
            "Sign_Signature": "MERCURY:SCORPIO|MARS:LEO|PLUTO:AQUARIUS",
            "Aspect_Signature": (
            ...
            "Date_Precision": "exact_day",
            "Selection_Group": "OCT_OPENING_PRESSURE",
            "Supersedes_Cluster_IDs": "2026_09_MONTH_END_TSQUARE_BUILDING",
            "Section_Order": 10,
            "Priority": 100,
            "Tags": "t_square;mercury;mars;pluto;carryover;completion",
        },
        {
            "Cluster_ID": "2026_10_MERCURY_VENUS_RETROGRADE_CONJUNCTION",
            "Event_Type": "aspect_cluster",
            "Valid_From": "2026-10-06T00:00:00+09:00",
            "Peak_At": "2026-10-07T09:10:00+09:00",
            "Valid_To": "2026-10-08T23:59:59+09:00",
            "Carryover_Flag": 0,
            "Participating_Planets": "MERCURY|VENUS",
            "Sign_Signature": "MERCURY:SCORPIO|VENUS:SCORPIO",
            "Aspect_Signature": "MERCURY-VENUS:0",
            "Max_Orb": 3,
            "Min_Planet_Count": 2,
            "Moon_Eligibility": "not_applicable",
            "Anchor_Planet": "VENUS",
            "Personalization_Mode": "anchor_house",
            "House_Token_Planets": "MERCURY|VENUS",
            "Date_Source": "swiss_ephemeris",
            "Date_Key": "MERCURY:VENUS:0:2026-10-07",
            "Date_Precision": "exact_day",
            "Selection_Group": "OCT_RETROGRADE_DIALOGUE",
            "Supersedes_Cluster_IDs": "",
            "Section_Order": 30,
            "Priority": 90,
            "Tags": "conjunction;mercury;venus;venus_retrograde;review",
        },
        {
            "Cluster_ID": "2026_10_VENUS_PLUTO_RETROGRADE_SQUARE",
            "Event_Type": "aspect_cluster",
            "Valid_From": "2026-10-18T00:00:00+09:00",
            "Peak_At": "2026-10-20T15:56:00+09:00",
            "Valid_To": "2026-10-22T23:59:59+09:00",
            "Carryover_Flag": 0,
            "Participating_Planets": "VENUS|PLUTO",
            "Sign_Signature": "VENUS:SCORPIO|PLUTO:AQUARIUS",
            "Aspect_Signature": "VENUS-PLUTO:90",
            ...
            "House_Token_Planets": "VENUS|PLUTO",
            "Date_Source": "swiss_ephemeris",
            "Date_Key": "VENUS:PLUTO:90:2026-10-20",
            "Date_Precision": "exact_day",
            "Selection_Group": "OCT_VALUES_POWER_REVIEW",
            "Supersedes_Cluster_IDs": "",
            "Section_Order": 55,
            "Priority": 90,
            "Tags": "square;venus;pluto;venus_retrograde;pluto_direct;review",
        },
        {
            "Cluster_ID": "2026_10_SUN_VENUS_CONJUNCTION",
            "Event_Type": "aspect_cluster",
            "Valid_From": "2026-10-23T00:00:00+09:00",
            "Peak_At": "2026-10-24T12:44:00+09:00",
            "Valid_To": "2026-10-25T23:59:59+09:00",
            "Carryover_Flag": 0,
            "Participating_Planets": "SUN|VENUS",
            "Sign_Signature": "SUN:SCORPIO|VENUS:SCORPIO",
            "Aspect_Signature": "SUN-VENUS:0",
            "Max_Orb": 3,
            "Min_Planet_Count": 2,
            "Moon_Eligibility": "not_applicable",
            "Anchor_Planet": "SUN",
            "Personalization_Mode": "anchor_house",
            "House_Token_Planets": "SUN|VENUS",
            "Date_Source": "swiss_ephemeris",
            "Date_Key": "SUN:VENUS:0:2026-10-24",
            "Date_Precision": "exact_day",
            "Selection_Group": "OCT_SOLAR_VENUS_PIVOT",
            "Supersedes_Cluster_IDs": "",
            "Section_Order": 70,
            "Priority": 95,
            "Tags": "conjunction;sun;venus;venus_retrograde;turning_point",
        },
        {
            "Cluster_ID": "2026_10_FULL_MOON_OUTER_NETWORK",
            "Event_Type": "aspect_cluster",
            "Valid_From": "2026-10-26T00:00:00+09:00",
            "Peak_At": "2026-10-26T13:12:00+09:00",
            "Valid_To": "2026-10-28T23:59:59+09:00",
            "Carryover_Flag": 0,
            "Participating_Planets": "SUN|MOON|URANUS|NEPTUNE|PLUTO",
            "Sign_Signature": (
                "SUN:SCORPIO|MOON:TAURUS|URANUS:GEMINI|"
                "NEPTUNE:ARIES|PLUTO:AQUARIUS"
            ),
            "Aspect_Signature": (
                "SUN-MOON:180|SUN-PLUTO:90|MOON-PLUTO:90|"
                "SUN-NEPTUNE:150|SUN-URANUS:150"
            ),
            "Max_Orb": 3,
            "Min_Planet_Count": 5,
            "Moon_Eligibility": "lunation_plus_planet",
            ...
            "Date_Source": "swiss_ephemeris",
            "Date_Key": (
                "FULL_MOON:2026-10-26|SUN:PLUTO:90:2026-10-26|"
                "SUN:URANUS:150:2026-10-28"
            ),
            "Date_Precision": "around_day",
            "Selection_Group": "OCT_FULL_MOON_OUTER_NETWORK",
            "Supersedes_Cluster_IDs": "",
            "Section_Order": 80,
            "Priority": 100,
            "Tags": "full_moon;t_square;sun;moon;uranus;neptune;pluto",
        },
    ],
}
